...
| Demo video 1–3 min, shows YouCam integration | **uploaded 2026-08-16** — https://youtu.be/ucrsgkAdgyE, unlisted, 164 s (2:44), the canonical 2026-08-15 cut from a production build with spoken narration and burned captions in the same words. Rebuildable from `submission/narration.txt` via `scripts/record-demo.mjs` + `scripts/build-demo-video.mjs`. Everything older, including the 2026-08-12 voiced cut, is do-not-publish |
